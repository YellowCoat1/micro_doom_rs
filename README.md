...
### Camera
The First line in the map file defines the starting position of the camera in the format:
```start_x start_y
```
Where (start_x, start_y) are the coordinates of the camera's starting position.
